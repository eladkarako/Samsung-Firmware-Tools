...
namespace MLFI.Interfaces
{
    public interface IUIPlugin
    {
        ...
        string CurrentFileTypeCode { get; set; }
        ToolStripMenuItem[] Menus { get; }
        //void Show(string filename, string type, string model, Form parent);
        //DialogResult ShowDialog(string filename, string type, string model, Form parent);
    }
}
